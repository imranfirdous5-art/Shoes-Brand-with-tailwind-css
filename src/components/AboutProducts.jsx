...
const AboutProducts = () => {
  ...
  const sizeStyle="border border-blue-300 w-16 flex flex-col items-center px-10 py-1 text-sm rounded-4xl capitalize hover:border-blue-600 transition-all duration-100 cursor-pointer";


  return (
    <>
      <div className="grid grid-rows-2 px-3 py-20 gap-1 bg-blue-100 border">
       <div className="h-fit md:mb-3 border">
        <img src={p1} alt="p1"className="w-full md:w-96 object-cover rounded-3xl" />
       </div>
