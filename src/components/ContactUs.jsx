  ...
  return (
    <>
      <div className="bg-blue-100 flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 gap-8 border border-blue-200 mx-auto rounded-2xl">
          <div className="mx-auto p-4 flex flex-col items-center w-full">
            <h6 className="text-2xl mb-2 w-72">We are here to help!</h6>
